...
const updateTaskAPI = process.env.REACT_APP_UPDATE_TASK_API_URL;
const deleteTaskAPI = process.env.REACT_APP_DELETE_TASK_API_URL;
const createTaskAPI = process.env.REACT_APP_CREATE_TASK_API_URL;
